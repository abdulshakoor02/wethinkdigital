...
export default function RelatedPosts({ currentPostId, currentPostKeywords = [] }: RelatedPostsProps) {
  ...
  return (
    <section className="py-16 bg-[#18191a] border-t border-gray-200">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {relatedPosts.map((post, index) => (
            <motion.article
              ...
              className="bg-[#1e1e20] rounded-lg p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all group"
            >
              <Link href={`/blog/${post.slug}`} className="block">
                ...
                <div className="flex items-center text-gray-600 text-sm font-medium mt-4 group-hover:text-gray-700 transition-colors">
